        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <h5>Pesanan anda sudah dicheck out selanjutnya untuk pembayaran silahkan transfer di rekening
                        <strong>Bank Kampret Rekening : 3213-1234-2341-1232</strong> dengan nominal : <strong>Rp. {{number_format($pesanan->jumlah_harga+ $pesanan->kode)}}</strong>
                    </h5>
                </div>
            </div>
            <div class="card">
